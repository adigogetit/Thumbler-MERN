        ...
        {!isLoading && thumbnail?.image_url &&  (
          <div className="group relative h-full w-full">
            ...
            <div className=" absolute inset-0 flex items-end justify-center bg-black/10 opicity-0 transition-opacity group-hover:opacity-100"> 
              <button type="button" className="mb-6 flex items-center gap-2 rounded-md bg-white/30 px-4 py-2 text-xs font-medium transition ring-2 ring-white/40 backdrop=blur hover:scale-105 active:scale-95">
